...
\newcommand{\subthrm}[2]{\textbf{#1}, \textit{#2}:}
\newcommand{\subdefinition}[1]{\subthrm{Definition}{#1}}
\newcommand{\subnotation}[1]{\subthrm{Notation}{#1}}
\newcommand{\projs}{\textbf{Projections}: }
\newcommand{\opers}{\textbf{Operations}: }
\newcommand{\motiv}[1]{The motivation for the #1 is that }
\newcommand{\motivdef}{\motiv{definition}}
\newcommand{\motivnot}{\motiv{notation}}
