...
In section 3 we define $\PCDL$. In section 4 we define $\ASDL$. In section 5
we define a modified Plonk based on $\PCDL$ and $\ASDL$ with all custom gates
needed to achieve an IVC-friendly SNARK. In section 6 define an IVC-circuit
for proving the validity of a chain of signatures. In section 7 we formally
define the arithmetization pipeline needed for the defined Plonk Scheme. In
section 8 we discuss the implementation of the IVC circuit for verifying a
chain of signatures, and benchmark the performance. Both this document and
